		...
		<div id="merit-scholarship" className="flex scroll-mt-4 flex-col gap-6">
				...
				{hasEstimate ? (
					<>
						...
						<p>
							...
							<span
								className={cn("font-bold", chanceColorClasses[chances])}>
								{chances}
							</span>{" "}
			...
			<Alert>
				...
				<AlertDescription>
					...
					Typically the application period for merit scholarships is at the start of October, but it's best to confirm the exact
					dates and requirements well in advance.
					<div className="mt-4">
						<Button asChild>
							<a
